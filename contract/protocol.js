...
class SampleProtocol extends Protocol{
    ...
    mapTxCommand(command){
        ...
        /tx --command '{"op":"seal_delivery_lane_lane","status":"MVP ready","note":"first demo"}' --sim 1
        ...
        */
        if (command === 'review_delivery_lane_lane') {
            obj.type = 'reviewDeliveryLaneLane';
            obj.value = null;
            return obj;
            ...
            */
            ...
            if (json && typeof json === 'object' && json.op !== undefined) {
                if (json.op === 'seal_delivery_lane_lane') {
                    obj.type = 'sealDeliveryLaneLane';
                    obj.value = json;
                    return obj;
                } else if (json.op === 'review_delivery_lane_lane') {
                    obj.type = 'reviewDeliveryLaneLane';
                    obj.value = null;
                    return obj;
    ...
    async printOptions(){
        ...
        console.log('- /tx --command \'{"op":"seal_delivery_lane_lane","status":"MVP ready","note":"first demo"}\' | seal latest delivery-lane card.');
        console.log('- /tx --command "review_delivery_lane_lane" | review latest delivery-lane card.');
