...
class SampleContract extends Contract {
    ...
    constructor(protocol, options = {}) {
        ...
        this.addSchema('sealDeliveryLaneLane', {
            value : {
                $$strict : true,
                $$type: "object",
        ...
        this.addFunction('reviewDeliveryLaneLane');
    ...
    async sealDeliveryLaneLane(){
        ...
        console.log('delivery lane sealed', laneCard);
    }

    async reviewDeliveryLaneLane(){
